...
![](../../../res/img/brd/starry-sky/v1.3/core/package_cont.png)
/// caption
包装和配件内容
///
...
![](../../../res/img/brd/starry-sky/v1.3/core/board_func_color.png)
/// caption
SoC底板板载资源
///
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/som_black_1.png)
/// caption
FPGA核心板正面
///

![](../../../res/img/brd/starry-sky/v1.3/fpga/som_black_2.png)
/// caption
FPGA核心板背面
///
...
![](../../../res/img/brd/starry-sky/v1.3/core/board_res.png)
/// caption
硬件资源
///
...
![](../../../res/img/brd/starry-sky/v1.3/core/test_flow.png)
/// caption
上电测试步骤
///
...
![](../../../res/img/brd/starry-sky/v1.3/core/datapath.png)
/// caption
一生一芯SoC支持的三种数据通路
///
...
!!! info "安装/拆卸FPGA核心板和晶振"
    ...
    ![](../../../res/img/brd/starry-sky/v1.3/fpga/sodimm_black_1.png)
    /// caption
    安装FPGA核心板
    ///
    ...
    ![](../../../res/img/brd/starry-sky/v1.3/perip/osc_1_1.png)
    /// caption
    晶振正确插入时方向
    ///

    ![](../../../res/img/brd/starry-sky/v1.3/perip/osc_2.png)
    /// caption
    晶振正确插入时深度
    ///
...
![](../../../res/img/brd/starry-sky/v1.3/perip/dip_switch_1.png)
/// caption
拨码开关位功能定义
///
...
![](../../../res/img/brd/starry-sky/v1.3/core/rcg_intro.png)
/// caption
三期SoC的RCG模块
///
...
!!! tip "时钟拨码开关设置"
    ...
    ![](../../../res/img/brd/starry-sky/v1.3/perip/dip_switch_2.png)
    /// caption
...
!!! tip "提示"
    ...
    ![](../../../res/img/brd/starry-sky/v1.3/perip/osc_tp.png)
    /// caption
    时钟频率测试点
    ///
...
![](../../../res/img/brd/starry-sky/v1.3/core/soc_intro.png)
/// caption
三期SoC架构图
///
...
![](../../../res/img/brd/starry-sky/v1.3/perip/dip_switch_3.png)
/// caption
拨码开关与序号对应关系
///
...
![](../../../res/img/brd/starry-sky/v1.3/perip/dip_switch_4.png)
/// caption
...
![](../../../res/img/brd/starry-sky/v1.3/perip/uart_1.png)
/// caption
滑动开关设置
///
...
![](../../../res/img/brd/starry-sky/v1.3/perip/uart_2.png)
/// caption
给板卡供电
///
...
![](../../../res/img/brd/starry-sky/v1.3/perip/uart_3.png)
/// caption
FPGA核心板启动模式设置
///
...
![](../../../res/img/brd/starry-sky/v1.3/perip/uart_4.png)
/// caption
按动复位按键执行SoC复位
///
...
![](../../../res/img/brd/starry-sky/v1.3/core/rtthread.png)
/// caption
运行RT-Thread测试程序
///
...
!!! info "丰富应用实例"
    ...
    ![](../../../res/img/brd/starry-sky/v1.3/core/app_1.png)
    /// caption
    启动Linux并运行程序
    ///
...
![](../../../res/img/brd/starry-sky/v1.3/core/pcb.png)
/// caption
板卡硬件设计
///
...
![](../../../res/img/brd/starry-sky/v1.3/core/board_smt_top.png)
/// caption
板卡顶层贴片
///

![](../../../res/img/brd/starry-sky/v1.3/core/board_smt_bot.png)
/// caption
板卡底层贴片
///
...
![](../../../res/img/brd/starry-sky/v1.3/core/power_tp.png)
/// caption
板卡电源网络拓扑
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_pwr_sck.png)
/// caption
电源输入接口
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_pwr_sel.png)
/// caption
电源选择开关
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_pwr_ldo.png)
/// caption
电源转换电路
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_soc_core.png)
/// caption
SoC核心电路局部
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_hfplink.png)
/// caption
板载烧写器
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_soc_sw.png)
/// caption
SoC拨码开关
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_soc_rst.png)
/// caption
SoC复位按键
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_soc_uart.png)
/// caption
SoC USB转串口
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_soc_tf.png)
/// caption
SoC TF接口
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_soc_func_sw.png)
/// caption
SoC功能切换开关
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_ps_boot_rst.png)
/// caption
SoC启动模式和复位按键
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_ps_jtag.png)
/// caption
FPGA JTAG调试接口
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_ps_uart.png)
/// caption
PS UART
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_ps_tf.png)
/// caption
PS SDIO
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_ps_wifi.png)
/// caption
PS SDIO WiFi
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_ps_can.png)
/// caption
PS CAN
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_ps_usb.png)
/// caption
PS USB HOST
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_ps_ws_pmod.png)
/// caption
PS WS2812和PMOD
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_ps_led_key.png)
/// caption
PS LED和KEY
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_pl_vga.png)
/// caption
PL VGA
///
...
!!! info "电阻网络阻值计算"
    ...
    ![](../../../res/img/brd/starry-sky/v1.3/sch/vga_dac_sim.png)
    /// caption
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_pl_ps2.png)
/// caption
PL PS/2
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_pl_i2c.png)
/// caption
PL RTC和EEPROM
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_pl_spi.png)
/// caption
PL SPI Flash
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_pl_i2s.png)
/// caption
PL I2S
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_pl_led_key.png)
/// caption
PL LED和KEY
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_pl_ws_uclk.png)
/// caption
PL WS2812和UCLK
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_pl_func_sw.png)
/// caption
PL 外设切换开关
///
...
![](../../../res/img/brd/starry-sky/v1.3/sch/sch_sodimm.png)
/// caption
SO-DIMM 204P接口
///
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/pl_perip_1.png)
/// caption
PL外设开关设置1
///
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/pl_led.png)
/// caption
PL LED闪烁
///
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/pl_rtc_ila_1.png)
/// caption
RTC ILA第一次采样
///

![](../../../res/img/brd/starry-sky/v1.3/fpga/pl_rtc_ila_2.png)
/// caption
RTC ILA第二次采样
///
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/pl_spi_ila_1.png)
/// caption
SPI ILA等待采样触发
///
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/pl_key.png)
/// caption
PL KEY
///
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/pl_spi_ila_2.png)
/// caption
SPI ILA采样结果
///
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/pl_eeprom_ila_1.png)
/// caption
EEPROM ILA等待触发
///
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/pl_eeprom_ila_2.png)
/// caption
EEPROM ILA采样结果
///
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/pl_vga_kdb.png)
/// caption
VGA和PS/2线与板卡连接
///
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/pl_perip_2.png)
/// caption
PL外设开关设置2
///
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/pl_vga_ps2_1.png)
/// caption
显示彩色条纹
///

![](../../../res/img/brd/starry-sky/v1.3/fpga/pl_vga_ps2_2.png)
/// caption
切换成绿色
///
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/chiplink_addr_map.png)
/// caption
ZYNQ OCM/DDR的地址映射
///
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/chiplink_bd.png)
/// caption
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/chiplink_contr.png)
/// caption
ChipLink时序约束
///
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/chiplink_log.png)
/// caption
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/chiplink_axi4_ila.png)
/// caption
AXI4 ILA协议采样
///
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/chiplink_ctrl_ila_1.png)
/// caption
ChipLink控制器 ILA采样1
///

![](../../../res/img/brd/starry-sky/v1.3/fpga/chiplink_ctrl_ila_2.png)
/// caption
ChipLink控制器 ILA采样2
///
...
![](../../../res/img/brd/starry-sky/v1.3/fpga/chiplink_ctrl_vcs.png)
/// caption
ChipLink控制器 VCS仿真
///
