...
![](/res/images/board/res/v2p1/package-cont.png)
/// caption
包装和配件内容
///
...
![](/res/images/board/res/v2p1/board-func-top-color.png)
/// caption
SoC底板板载资源1
///

![](/res/images/board/res/v2p1/board-func-bot-color.png)
/// caption
SoC底板板载资源2
///
...
![](/res/images/board/fpga/v2p1/som-black.png)
/// caption
FPGA核心板正反面
///
...
![](/res/images/board/res/v2p1/board-res.png)
/// caption
硬件资源
///
...
![](/res/images/board/res/v2p1/test-flow.png)
/// caption
上电测试步骤
///
...
![](/res/images/board/res/v2p1/datapath.png)
/// caption
一生一芯SoC支持的三种数据通路
///
...
![](/res/images/board/res/v2p1/rcg-intro.png)
/// caption
四期SoC的RCG模块
///
...
![](/res/images/board/perip/v2p1/dip-switch-1.png)
/// caption
拨码开关位功能定义
///
...
!!! tip "提示"
    ...
    ![](/res/images/board/perip/v2p1/osc-tp.png)
    /// caption
    时钟频率测试点
    ///
...
![](/res/images/board/res/v2p1/soc-intro.png)
/// caption
四期SoC架构图
///
...
![](/res/images/board/perip/v2p1/dip-switch-3.png)
/// caption
拨码开关与序号对应关系
///
...
![](/res/images/board/perip/v2p1/dip-switch-4.png)
/// caption
...
![](/res/images/board/perip/v2p1/uart-1.png)
/// caption
滑动开关设置
///
...
![](/res/images/board/perip/v2p1/uart-2.png)
/// caption
给板卡供电
///
...
![](/res/images/board/perip/v2p1/uart-3.png)
/// caption
FPGA核心板启动模式设置
///
...
![](/res/images/board/perip/v2p1/uart-4.png)
/// caption
按动复位按键执行SoC复位
///
...
![](/res/images/board/res/v2p1/rtthread.png)
/// caption
运行RT-Thread测试程序
///
...
!!! info "丰富应用实例"
    ...
    ![](/res/images/board/res/v2p1/app-1.png)
    /// caption
    启动Linux并运行程序
    ///
...
![](/res/images/board/tool/hfp-1-v2p1.png)
/// caption
使能板载烧写器
///
...
![](/res/images/board/res/v2p1/app-kdb-sw.png)
/// caption
将外设模式开关拨到左侧
///
...
![](/res/images/board/res/v2p1/app-kdb.png)
/// caption
运行PS/2键盘测试程序
///
...
!!! info "更新板载烧写器固件"
    ...
    ![](/res/images/board/tool/hfplink-fireware-update-v2p1.png)
    /// caption
    板载烧写器复位和模式选择按键位置
    ///
...
!!! info "两线串行调试接口固件更新"
    ...
    ![](/res/images/board/tool/hfplink-2wire-v2p1.png)
    /// caption
    两线调试接口测试点
    ///
...
![](/res/images/board/res/v2p1/pcb-sch.png)
/// caption
板卡硬件原理图设计
///

![](/res/images/board/res/v2p1/pcb-layout.png)
/// caption
板卡硬件PCB布局布线
///

![](/res/images/board/res/v2p1/pcb-3d.png)
/// caption
板卡硬件3D结构
///
...
![](/res/images/board/res/v2p1/board-smt-top.png)
/// caption
板卡顶层贴片
///

![](/res/images/board/res/v2p1/board-smt-bot.png)
/// caption
板卡底层贴片
///
...
![](/res/images/board/res/v2p1/power-tp.png)
/// caption
板卡电源网络拓扑
///
...
![](/res/images/board/sch/v2p1/sch-pwr-sck.png)
/// caption
电源输入接口
///
...
![](/res/images/board/sch/v2p1/sch-pwr-sel.png)
/// caption
电源选择开关
///
...
![](/res/images/board/sch/v2p1/sch-pwr-ldo.png)
/// caption
电源转换电路
///
...
![](/res/images/board/sch/v2p1/sch-soc-core.png)
/// caption
SoC核心电路局部
///
...
![](/res/images/board/sch/v2p1/sch-hfplink.png)
/// caption
板载烧写器
///
...
![](/res/images/board/sch/v2p1/sch-soc-sw.png)
/// caption
SoC拨码开关
///
...
![](/res/images/board/sch/v2p1/sch-soc-rst.png)
/// caption
SoC复位按键
///
...
![](/res/images/board/sch/v2p1/sch-soc-uart.png)
/// caption
SoC USB转串口
///
...
![](/res/images/board/sch/v2p1/sch-soc-tf.png)
/// caption
SoC TF接口
///
...
![](/res/images/board/sch/v2p1/sch-soc-func-sw.png)
/// caption
SoC功能切换开关
///
...
![](/res/images/board/sch/v2p1/sch-soc-sdram.png)
/// caption
SoC LPSDRAM颗粒
///
...
![](/res/images/board/sch/v2p1/sch-ps-boot-rst.png)
/// caption
SoC启动模式和复位按键
///
...
![](/res/images/board/sch/v2p1/sch-ps-jtag.png)
/// caption
FPGA JTAG调试接口
///
...
![](/res/images/board/sch/v2p1/sch-ps-uart.png)
/// caption
PS UART
///
...
![](/res/images/board/sch/v2p1/sch-ps-tf.png)
/// caption
PS SDIO
///
...
![](/res/images/board/sch/v2p1/sch-ps-usb.png)
/// caption
PS USB HOST
///
...
![](/res/images/board/sch/v2p1/sch-ps-led-key.png)
/// caption
PS LED和KEY
///
...
![](/res/images/board/sch/v2p1/sch-pl-vga.png)
/// caption
PL VGA
///
...
!!! info "电阻网络阻值计算"
    ...
    ![](/res/images/board/sch/v2p1/vga-dac-sim.png)
    /// caption
...
![](/res/images/board/sch/v2p1/sch-pl-ps2.png)
/// caption
PL PS/2
///
...
![](/res/images/board/sch/v2p1/sch-pl-i2c.png)
/// caption
PL RTC和EEPROM
///
...
![](/res/images/board/sch/v2p1/sch-pl-spi.png)
/// caption
PL SPI Flash
///
...
![](/res/images/board/sch/v2p1/sch-pl-tft.png)
/// caption
PL SPI Flash
///
...
![](/res/images/board/sch/v2p1/sch-pl-tf.png)
/// caption
PL SPI TF
///
...
![](/res/images/board/sch/v2p1/sch-pl-uart.png)
/// caption
PL UART
///
...
![](/res/images/board/sch/v2p1/sch-pl-i2s.png)
/// caption
PL I2S
///
...
![](/res/images/board/sch/v2p1/sch-pl-sdram.png)
/// caption
PL LPSDRAM
///
...
![](/res/images/board/sch/v2p1/sch-pl-led-key.png)
/// caption
PL LED和KEY
///
...
![](/res/images/board/sch/v2p1/sch-pl-ws.png)
/// caption
PL WS2812和UCLK
///
...
![](/res/images/board/sch/v2p1/sch-pl-func-sw.png)
/// caption
PL 外设切换开关
///
...
![](/res/images/board/sch/v2p1/sch-pl-extn.png)
/// caption
PL EXTN
///
...
![](/res/images/board/sch/v2p1/sch-pl-pwr-clk.png)
/// caption
PL 外置晶振和BANK电压设置
///
...
![](/res/images/board/sch/v2p1/sch-btb.png)
/// caption
BTB 100P接口
///
...
![](/res/images/board/fpga/v2p1/pl-perip-1.png)
/// caption
PL FPGA启动模式切换
///
...
![](/res/images/board/fpga/v2p1/pl-perip-2.png)
/// caption
PL外设开关滑动到右侧
///
...
![](/res/images/board/fpga/v2p1/pl-lcd-wire.png)
/// caption
插入TFT-LCD屏幕
///
...
![](/res/images/board/fpga/v2p1/pl-wire.png)
/// caption
各线缆与板卡连接
///
...
![](/res/images/board/fpga/v2p1/pl-vga-ps2-1.png)
/// caption
显示彩色条纹
///

![](/res/images/board/fpga/v2p1/pl-vga-ps2-2.png)
/// caption
切换成绿色
///

![](/res/images/board/fpga/v2p1/pl-testall.png)
/// caption
...
![](/res/images/board/fpga/v2p1/pl-rtc-ila-1.png)
/// caption
RTC ILA第一次采样
///

![](/res/images/board/fpga/v2p1/pl-rtc-ila-2.png)
/// caption
RTC ILA第二次采样
///
...
![](/res/images/board/fpga/v2p1/pl-spi-ila-1.png)
/// caption
SPI ILA等待采样触发
///
...
![](/res/images/board/fpga/v2p1/pl-key.png)
/// caption
PL KEY
///
...
![](/res/images/board/fpga/v2p1/pl-spi-ila-2.png)
/// caption
SPI ILA采样结果
///
...
![](/res/images/board/fpga/v2p1/pl-eeprom-ila-1.png)
/// caption
EEPROM ILA等待触发
///
...
![](/res/images/board/fpga/v2p1/pl-eeprom-ila-2.png)
/// caption
EEPROM ILA采样结果
///
...
![](/res/images/board/fpga/v2p1/pl-tf-intro.png)
/// caption
PL SPI TF插槽
///
...
![](/res/images/board/fpga/v2p1/pl-tf-ila-1.png)
/// caption
SPI TF ILA等待触发
///
...
![](/res/images/board/fpga/v2p1/pl-tf-ila-2.png)
/// caption
SPI TF ILA采样结果
///
...
![](/res/images/board/fpga/v2p1/chiplink-addr-map.png)
/// caption
ZYNQ OCM/DDR的地址映射
///
...
![](/res/images/board/fpga/v2p1/chiplink-bd.png)
/// caption
...
![](/res/images/board/fpga/v2p1/chiplink-contr.png)
/// caption
ChipLink时序约束
///
...
![](/res/images/board/fpga/v2p1/chiplink-log.png)
/// caption
...
![](/res/images/board/fpga/v2p1/chiplink-axi4-ila.png)
/// caption
AXI4 ILA协议采样
///
...
![](/res/images/board/fpga/v2p1/chiplink-ctrl-ila-1.png)
/// caption
ChipLink控制器 ILA采样1
///

![](/res/images/board/fpga/v2p1/chiplink-ctrl-ila-2.png)
/// caption
ChipLink控制器 ILA采样2
///
...
![](/res/images/board/fpga/v2p1/chiplink-ctrl-vcs.png)
/// caption
ChipLink控制器 VCS仿真
///
