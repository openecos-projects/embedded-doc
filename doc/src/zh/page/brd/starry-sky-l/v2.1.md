...
![](../../../res/img/brd/starry-sky-l/v2.1/core/package_cont.webp)
/// caption
包装和配件内容
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/core/board_func_top_color.webp)
/// caption
SoC底板板载资源1
///

![](../../../res/img/brd/starry-sky-l/v2.1/core/board_func_bot_color.webp)
/// caption
SoC底板板载资源2
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/som_black.webp)
/// caption
FPGA核心板正反面
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/core/board_res.webp)
/// caption
硬件资源
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/core/test_flow.webp)
/// caption
上电测试步骤
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/core/datapath.webp)
/// caption
一生一芯SoC支持的三种数据通路
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/core/rcg_intro.webp)
/// caption
四期SoC的RCG模块
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/perip/dip_switch_1.webp)
/// caption
拨码开关位功能定义
///
...
!!! tip "提示"
    ...
    ![](../../../res/img/brd/starry-sky-l/v2.1/perip/osc_tp.webp)
    /// caption
    时钟频率测试点
    ///
...
![](../../../res/img/brd/starry-sky-l/v2.1/core/soc_intro.webp)
/// caption
四期SoC架构图
///

!!! info "实际流片时VGA DAC和Ethernet MAC的实现"
...
![](../../../res/img/brd/starry-sky-l/v2.1/perip/dip_switch_3.webp)
/// caption
拨码开关与序号对应关系
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/perip/dip_switch_4.webp)
/// caption
...
![](../../../res/img/brd/starry-sky-l/v2.1/perip/uart_1.webp)
/// caption
滑动开关设置
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/perip/uart_2.webp)
/// caption
给板卡供电
///
...
![](../../../res/img/brd/starry-sky-l/tool/cp2102_1.webp)
/// caption
设备管理器显示CP2102端口
///
...
![](../../../res/img/brd/starry-sky-l/tool/cp2102_2.webp)
/// caption
在其他设备中出现黄色叹号
///
...
![](../../../res/img/brd/starry-sky-l/tool/cp2102_3.webp)
/// caption
安装CP2102驱动程序
///
...
??? quote "CP2102设备识别问题"
    ...
    ![](../../../res/img/brd/starry-sky-l/tool/cp2102_prb_1.webp)
    /// caption
    CP2102设备识别问题
    ///
    ...
    ![](../../../res/img/brd/starry-sky-l/tool/cp2102_prb_2.webp)
    /// caption
    右键点击更新驱动
    ///
    ...
    ![](../../../res/img/brd/starry-sky-l/tool/cp2102_prb_3.webp)
    /// caption
    从电脑上选取驱动程序
    ///
    ...
    ![](../../../res/img/brd/starry-sky-l/tool/cp2102_prb_4.webp)
    /// caption
    选择设备类型
    ///
    ...
    ![](../../../res/img/brd/starry-sky-l/tool/cp2102_prb_5.webp)
    /// caption
    选择驱动程序
    ///
    ...
    ![](../../../res/img/brd/starry-sky-l/tool/cp2102_prb_6.webp)
    /// caption
    更新驱动
    ///
...
![](../../../res/img/brd/starry-sky-l/tool/mobaxterm_intro_1.webp)
/// caption
MobaXterm软件
///
...
![](../../../res/img/brd/starry-sky-l/tool/mobaxterm_intro_2.webp)
/// caption
MobaXterm软件
///
...
![](../../../res/img/brd/starry-sky-l/tool/mobaxterm_intro_3.webp)
/// caption
新建串口会话
///
...
![](../../../res/img/brd/starry-sky-l/tool/mobaxterm_intro_3_1.webp)
/// caption
正确打开串口会话
///
...
![](../../../res/img/brd/starry-sky-l/tool/mobaxterm_intro_4.webp)
/// caption
修改串口换行显示1
///

![](../../../res/img/brd/starry-sky-l/tool/mobaxterm_intro_5.webp)
/// caption
修改串口换行显示2
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/perip/uart_3.webp)
/// caption
FPGA核心板启动模式设置
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/perip/uart_4.webp)
/// caption
按动复位按键执行SoC复位
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/core/rtthread.webp)
/// caption
运行RT-Thread测试程序
///
...
!!! info "丰富应用实例"
    ...
    ![](../../../res/img/brd/starry-sky-l/v2.1/core/app_1.webp)
    /// caption
    启动Linux并运行程序
    ///
...
![](../../../res/img/brd/starry-sky-l/tool/hfp_1_v2p1.webp)
/// caption
使能板载烧写器
///
...
![](../../../res/img/brd/starry-sky-l/tool/hfp_2.webp)
/// caption
识别出U盘
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/core/app_kdb_sw.webp)
/// caption
将外设模式开关拨到左侧
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/core/app_kdb.webp)
/// caption
运行PS/2键盘测试程序
///
...
!!! info "更新板载烧写器固件"
    ...
    ![](../../../res/img/brd/starry-sky-l/tool/hfp_3.webp)
    /// caption
    WCHISPTool界面
    ///
    ...
    ![](../../../res/img/brd/starry-sky-l/tool/hfplink_fireware_update_v2p1.webp)
    /// caption
    板载烧写器复位和模式选择按键位置
    ///
    ...
    **`NRST`**和**`BOOT`**这两个按键旁边有白色丝印指示，比较容易找到。当按照上面步骤操作完之后，WSHISPTool会自动识别出`CH32V103`这个芯片型号：
    ...
    ![](../../../res/img/brd/starry-sky-l/tool/hfp_4.webp)
    /// caption
    识别出CH32V103
    ///
    ...
    ![](../../../res/img/brd/starry-sky-l/tool/hfp_5.webp)
    /// caption
    下载固件
    ///
...
!!! info "两线串行调试接口固件更新"
    ...
    ![](../../../res/img/brd/starry-sky-l/tool/hfplink_2wire_v2p1.webp)
    /// caption
    两线调试接口测试点
    ///
...
![](../../../res/img/brd/starry-sky-l/v2.1/core/pcb_sch.webp)
/// caption
板卡硬件原理图设计
///

![](../../../res/img/brd/starry-sky-l/v2.1/core/pcb_layout.webp)
/// caption
板卡硬件PCB布局布线
///

![](../../../res/img/brd/starry-sky-l/v2.1/core/pcb_3d.webp)
/// caption
板卡硬件3D结构
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/core/board_smt_top.webp)
/// caption
板卡顶层贴片
///

![](../../../res/img/brd/starry-sky-l/v2.1/core/board_smt_bot.webp)
/// caption
板卡底层贴片
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/core/power_tp.webp)
/// caption
板卡电源网络拓扑
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_pwr_sck.webp)
/// caption
电源输入接口
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_pwr_sel.webp)
/// caption
电源选择开关
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_pwr_ldo.webp)
/// caption
电源转换电路
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_soc_core.webp)
/// caption
SoC核心电路局部
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_hfplink.webp)
/// caption
板载烧写器
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_soc_sw.webp)
/// caption
SoC拨码开关
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_soc_rst.webp)
/// caption
SoC复位按键
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_soc_uart.webp)
/// caption
SoC USB转串口
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_soc_tf.webp)
/// caption
SoC TF接口
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_soc_func_sw.webp)
/// caption
SoC功能切换开关
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_soc_sdram.webp)
/// caption
SoC LPSDRAM颗粒
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_ps_boot_rst.webp)
/// caption
SoC启动模式和复位按键
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_ps_jtag.webp)
/// caption
FPGA JTAG调试接口
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_ps_uart.webp)
/// caption
PS UART
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_ps_tf.webp)
/// caption
PS SDIO
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_ps_usb.webp)
/// caption
PS USB HOST
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_ps_led_key.webp)
/// caption
PS LED和KEY
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_pl_vga.webp)
/// caption
PL VGA
///
...
!!! info "电阻网络阻值计算"
    ...
    ![](../../../res/img/brd/starry-sky-l/v2.1/sch/vga_dac_sim.webp)
    /// caption
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_pl_ps2.webp)
/// caption
PL PS/2
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_pl_i2c.webp)
/// caption
PL RTC和EEPROM
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_pl_spi.webp)
/// caption
PL SPI Flash
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_pl_tft.webp)
/// caption
PL SPI Flash
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_pl_tf.webp)
/// caption
PL SPI TF
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_pl_uart.webp)
/// caption
PL UART
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_pl_i2s.webp)
/// caption
PL I2S
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_pl_sdram.webp)
/// caption
PL LPSDRAM
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_pl_led_key.webp)
/// caption
PL LED和KEY
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_pl_ws.webp)
/// caption
PL WS2812和UCLK
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_pl_func_sw.webp)
/// caption
PL 外设切换开关
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_pl_extn.webp)
/// caption
PL EXTN
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_pl_pwr_clk.webp)
/// caption
PL 外置晶振和BANK电压设置
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/sch/sch_btb.webp)
/// caption
BTB 100P接口
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/pl_perip_1.webp)
/// caption
PL FPGA启动模式切换
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/pl_perip_2.webp)
/// caption
PL外设开关滑动到右侧
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/pl_lcd_wire.webp)
/// caption
插入TFT-LCD屏幕
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/pl_wire.webp)
/// caption
各线缆与板卡连接
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/pl_vga_ps2_1.webp)
/// caption
显示彩色条纹
///

![](../../../res/img/brd/starry-sky-l/v2.1/fpga/pl_vga_ps2_2.webp)
/// caption
切换成绿色
///

![](../../../res/img/brd/starry-sky-l/v2.1/fpga/pl_testall.webp)
/// caption
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/pl_rtc_ila_1.webp)
/// caption
RTC ILA第一次采样
///

![](../../../res/img/brd/starry-sky-l/v2.1/fpga/pl_rtc_ila_2.webp)
/// caption
RTC ILA第二次采样
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/pl_spi_ila_1.webp)
/// caption
SPI ILA等待采样触发
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/pl_key.webp)
/// caption
PL KEY
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/pl_spi_ila_2.webp)
/// caption
SPI ILA采样结果
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/pl_eeprom_ila_1.webp)
/// caption
EEPROM ILA等待触发
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/pl_eeprom_ila_2.webp)
/// caption
EEPROM ILA采样结果
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/pl_tf_intro.webp)
/// caption
PL SPI TF插槽
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/pl_tf_ila_1.webp)
/// caption
SPI TF ILA等待触发
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/pl_tf_ila_2.webp)
/// caption
SPI TF ILA采样结果
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/chiplink_addr_map.webp)
/// caption
ZYNQ OCM/DDR的地址映射
///
...
```verilog
assign io_axi4_0_awaddr = aw_addr - 32'h8000_0000 + 32'h0010_0000;
assign io_axi4_0_araddr = ar_addr - 32'h8000_0000 + 32'h0010_0000;
assign chiplink_cpu_int = 1'b0;
```

这样将`chiplink_ctrl`添加到**Block Design**中并连接到ZYNQ系统上就完成了硬件设计，最终搭建好的硬件系统如下图所示：

![](../../../res/img/brd/starry-sky-l/v2.1/fpga/chiplink_bd.webp)
/// caption
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/chiplink_contr.webp)
/// caption
ChipLink时序约束
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/chiplink_log.webp)
/// caption
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/chiplink_axi4_ila.webp)
/// caption
AXI4 ILA协议采样
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/chiplink_ctrl_ila_1.webp)
/// caption
ChipLink控制器 ILA采样1
///

![](../../../res/img/brd/starry-sky-l/v2.1/fpga/chiplink_ctrl_ila_2.webp)
/// caption
ChipLink控制器 ILA采样2
///
...
![](../../../res/img/brd/starry-sky-l/v2.1/fpga/chiplink_ctrl_vcs.webp)
/// caption
ChipLink控制器 VCS仿真
///
