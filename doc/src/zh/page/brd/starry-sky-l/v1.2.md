...
![](../../../res/img/brd/starry-sky-l/v1.2/core/package_cont.webp)
/// caption
包装和配件内容
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/core/soc_silk.webp)
/// caption
SoC上的丝印编号
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/core/board_func_color.webp)
/// caption
SoC底板板载资源
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/som_black_1.webp)
/// caption
FPGA核心板正面
///

![](../../../res/img/brd/starry-sky-l/v1.2/fpga/som_black_2.webp)
/// caption
FPGA核心板背面
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/core/board_res.webp)
/// caption
硬件资源
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/core/test_flow.webp)
/// caption
上电测试步骤
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/core/datapath.webp)
/// caption
一生一芯SoC支持的三种数据通路
///
...
!!! info "安装/拆卸FPGA核心板和晶振"
    ...
    ![](../../../res/img/brd/starry-sky-l/v1.2/fpga/sodimm_black_1.webp)
    /// caption
    安装FPGA核心板
    ///
    ...
    ![](../../../res/img/brd/starry-sky-l/v1.2/perip/osc_1_1.webp)
    /// caption
    晶振正确插入时方向
    ///

    ![](../../../res/img/brd/starry-sky-l/v1.2/perip/osc_2.webp)
    /// caption
    晶振正确插入时深度
    ///
...
![](../../../res/img/brd/starry-sky-l/v1.2/perip/dip_switch_1.webp)
/// caption
拨码开关位功能定义
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/core/rcg_intro.webp)
/// caption
三期SoC的RCG模块
///
...
!!! tip "时钟拨码开关设置"
    ...
    ![](../../../res/img/brd/starry-sky-l/v1.2/perip/dip_switch_2.webp)
    /// caption
...
!!! tip "提示"
    ...
    ![](../../../res/img/brd/starry-sky-l/v1.2/perip/osc_tp.webp)
    /// caption
    时钟频率测试点
    ///
...
![](../../../res/img/brd/starry-sky-l/v1.2/core/soc_intro.webp)
/// caption
三期SoC架构图
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/perip/dip_switch_3.webp)
/// caption
拨码开关与序号对应关系
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/perip/dip_switch_4.webp)
/// caption
...
![](../../../res/img/brd/starry-sky-l/v1.2/perip/uart_1.webp)
/// caption
滑动开关设置
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/perip/uart_2.webp)
/// caption
给板卡供电
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/perip/uart_3.webp)
/// caption
FPGA核心板启动模式设置
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/perip/uart_4.webp)
/// caption
按动复位按键执行SoC复位
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/core/rtthread.webp)
/// caption
运行RT-Thread测试程序
///
...
!!! info "丰富应用实例"
    ...
    ![](../../../res/img/brd/starry-sky-l/v1.2/core/app_1.webp)
    /// caption
    启动Linux并运行程序
    ///
...
![](../../../res/img/brd/starry-sky-l/tool/hfp_1.webp)
/// caption
使能板载烧写器
///
...
!!! info "更新板载烧写器固件"
    ...
    ![](../../../res/img/brd/starry-sky-l/tool/hfplink_fireware_update.webp)
    /// caption
    板载烧写器复位和模式选择按键位置
    ///
...
!!! info "两线串行调试接口固件更新"
    ...
    ![](../../../res/img/brd/starry-sky-l/tool/hfplink_2wire.webp)
    /// caption
    两线调试接口测试点
    ///
...
![](../../../res/img/brd/starry-sky-l/v1.2/core/pcb.webp)
/// caption
板卡硬件设计
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/core/board_smt_top.webp)
/// caption
板卡顶层贴片
///

![](../../../res/img/brd/starry-sky-l/v1.2/core/board_smt_bot.webp)
/// caption
板卡底层贴片
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/core/power_tp.webp)
/// caption
板卡电源网络拓扑
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_pwr_sck.webp)
/// caption
电源输入接口
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_pwr_sel.webp)
/// caption
电源选择开关
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_pwr_ldo.webp)
/// caption
电源转换电路
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_soc_core.webp)
/// caption
SoC核心电路局部
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_hfplink.webp)
/// caption
板载烧写器
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_soc_sw.webp)
/// caption
SoC拨码开关
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_soc_rst.webp)
/// caption
SoC复位按键
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_soc_uart.webp)
/// caption
SoC USB转串口
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_soc_tf.webp)
/// caption
SoC TF接口
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_soc_func_sw.webp)
/// caption
SoC功能切换开关
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_ps_boot_rst.webp)
/// caption
SoC启动模式和复位按键
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_ps_jtag.webp)
/// caption
FPGA JTAG调试接口
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_ps_uart.webp)
/// caption
PS UART
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_ps_tf.webp)
/// caption
PS SDIO
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_ps_wifi.webp)
/// caption
PS SDIO WiFi
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_ps_can.webp)
/// caption
PS CAN
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_ps_usb.webp)
/// caption
PS USB HOST
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_ps_ws_pmod.webp)
/// caption
PS WS2812和PMOD
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_ps_led_key.webp)
/// caption
PS LED和KEY
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_pl_vga.webp)
/// caption
PL VGA
///
...
!!! info "电阻网络阻值计算"
    ...
    ![](../../../res/img/brd/starry-sky-l/v1.2/sch/vga_dac_sim.webp)
    /// caption
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_pl_ps2.webp)
/// caption
PL PS/2
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_pl_i2c.webp)
/// caption
PL RTC和EEPROM
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_pl_spi.webp)
/// caption
PL SPI Flash
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_pl_i2s.webp)
/// caption
PL I2S
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_pl_led_key.webp)
/// caption
PL LED和KEY
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_pl_ws_uclk.webp)
/// caption
PL WS2812和UCLK
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_pl_func_sw.webp)
/// caption
PL 外设切换开关
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/sch/sch_sodimm.webp)
/// caption
SO-DIMM 204P接口
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/pl_perip_1.webp)
/// caption
PL外设开关设置1
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/pl_led.webp)
/// caption
PL LED闪烁
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/pl_rtc_ila_1.webp)
/// caption
RTC ILA第一次采样
///

![](../../../res/img/brd/starry-sky-l/v1.2/fpga/pl_rtc_ila_2.webp)
/// caption
RTC ILA第二次采样
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/pl_spi_ila_1.webp)
/// caption
SPI ILA等待采样触发
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/pl_key.webp)
/// caption
PL KEY
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/pl_spi_ila_2.webp)
/// caption
SPI ILA采样结果
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/pl_eeprom_ila_1.webp)
/// caption
EEPROM ILA等待触发
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/pl_eeprom_ila_2.webp)
/// caption
EEPROM ILA采样结果
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/pl_vga_kdb.webp)
/// caption
VGA和PS/2线与板卡连接
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/pl_perip_2.webp)
/// caption
PL外设开关设置2
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/pl_vga_ps2_1.webp)
/// caption
显示彩色条纹
///

![](../../../res/img/brd/starry-sky-l/v1.2/fpga/pl_vga_ps2_2.webp)
/// caption
切换成绿色
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/pl_ws.webp)
/// caption
WS2812C显示4种颜色
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/chiplink_addr_map.webp)
/// caption
ZYNQ OCM/DDR的地址映射
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/chiplink_bd.webp)
/// caption
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/chiplink_contr.webp)
/// caption
ChipLink时序约束
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/chiplink_log.webp)
/// caption
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/chiplink_axi4_ila.webp)
/// caption
AXI4 ILA协议采样
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/chiplink_ctrl_ila_1.webp)
/// caption
ChipLink控制器 ILA采样1
///

![](../../../res/img/brd/starry-sky-l/v1.2/fpga/chiplink_ctrl_ila_2.webp)
/// caption
ChipLink控制器 ILA采样2
///
...
![](../../../res/img/brd/starry-sky-l/v1.2/fpga/chiplink_ctrl_vcs.webp)
/// caption
ChipLink控制器 VCS仿真
///
